   ...
   [23], {
      523: (e, r, o) => {
         ...
         let U = function (e, ...r) {
            let o, t, n;
            let l = function (a) {
               return t = (o = g(r.reduce((e, r) => r(e), e()))).cache.get,
                  n = o.cache.set,
                  l = s,
                  s(a)
            };
            ...
            return {
               ...
               classGroups: {
                  ...
                  "min-w": [{
                     "min-w": [O, r, "min", "max", "fit"]
                  }],
                  "max-w": [{
                     "max-w": [O, r, "none", "full", "min", "max", "fit", "prose", {
                        screen: [R]
                     }, R]
                  }],
                  h: [{
                  ...
                  leading: [{
                     leading: ["none", "tight", "snug", "normal", "relaxed", "loose", N, O]
                  }],
                  "list-image": [{
                     "list-image": ["none", O]
                  }],
